  ...
  return (
    <>
      ...
      <div className="edit-request">
        <h2 className="edit-request__title">Edit your profile</h2>
        <p className="edit-request__instructions">Please enter your new information below:</p>
        <div className="edit-request__form-container">
          <form className="edit-request__form" onSubmit={handleEdit}>
